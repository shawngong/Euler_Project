...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "Catchtoad.py"

        #Name of program
        self.project_name = "Catchtoad"
        ...
        self.license = "Shawn Gong License"

        #Auhor of program
        self.author_name = "Shawn"
        self.author_email = "shawngong1996@hotmail.com"
        self.copyright = "Copyright (c) 2014."

        #Description
        self.project_description = "Move Mario using the arrow keys and help him catch the randomly Spawning toads! Once you get all the toads you complete the level! The toads start spawning faster as each level progresses."
